...
export default function PayrollTable({
  ...
  const [sortSalary, setSortSalary] =
                  ...
                  paginatedPayrolls.map(
                    (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <div className="flex items-center gap-3">
                            {/* <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-amber-100 font-bold text-amber-700">
                              {item.staff_name?.charAt(
                                0,
                              )}
                            </div> */}
