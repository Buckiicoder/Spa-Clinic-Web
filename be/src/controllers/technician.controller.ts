 ...
 */
export const getWorkingTechnicians = async (req: Request, res: Response) => {
...
export const assignTechnician = async (req: Request, res: Response) => {
  try {
    ...
    const session = await technicianService.assignTechnicianToSession(
      session_id,
      technician_id,
      managerId,
    );
...
export const getMySessions = async (req: Request, res: Response) => {
  ...
  const data = await technicianService.getMyAssignedSessions(technicianId);
...
export const getSessionDetail = async (req: Request, res: Response) => {
  try {
    ...
    const history = await technicianService.getSessionHistory(data.profile_id);
